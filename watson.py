...
#route to .zip file = /Users/Michelle/Documents/Michelle/Projects/Personal Projects/Hackathons/Signature Analysis

#print(json.dumps(visual_recognition.classify(images_url="https://i.ytimg.com/vi/tntOCGkgt98/maxresdefault.jpg"), indent=2))

print(json.dumps(visual_recognition.classify(images_file="/Users/Michelle/Documents/Michelle/Projects/Personal Projects/Hackathons/Signature Analysis/test1.zip"), indent=2))
